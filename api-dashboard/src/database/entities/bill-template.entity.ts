...
export class BillTemplate {
  ...
  itemDisplayLayout: string; // standard, compact, detailed, two_line, price_right, with_index, grouped, grid_2_col, minimal, dotted, boxed, table, table_stt, table_qty_first, table_full
